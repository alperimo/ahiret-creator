...
Item {
    ...
    Rectangle{id: page_title_bg; width: main_page_ref.scene_width; height: 31; color: "#1c1c1c"
        Text{id: page_title; anchors.verticalCenter: parent.verticalCenter; anchors.left: parent.left; anchors.leftMargin: 6
