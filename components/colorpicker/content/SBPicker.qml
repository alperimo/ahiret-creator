...
Item {
    ...
    property real saturation : pickerCursor.x/(divided_w)
    property real brightness : 1 - pickerCursor.y/(divided_h)
    property int r : colorHandleRadius

    property real divided_w: width-2*r
    property real divided_h: height-2*r
